...
public class FilterPreferenceFragment extends AbstractPreferenceFragment {
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        imperialUnits = preferences.getBoolean(PrefConstants.IMPERIAL_UNITS, false);
    }
    ...
    private void prepareCacheTypePreference() {
        ...
        cacheTypeFilterScreen.setSummary(premiumMember ? prepareCacheTypeSummary() : prepareCacheTypeSummaryBasicMember());
        if (!premiumMember) {
    ...
    private void prepareContainerTypePreference() {
        ...
        containerTypeFilterScreen.setSummary(
                premiumMember ? prepareContainerTypeSummary() : prepareContainerTypeSummaryBasicMember());
        if (!premiumMember) {
    ...
    private void prepareDifficultyPreference() {
        ...
        if (premiumMember) {
            difficultyMin = preferences.getString(PrefConstants.FILTER_DIFFICULTY_MIN, difficultyMin);
            difficultyMax = preferences.getString(PrefConstants.FILTER_DIFFICULTY_MAX, difficultyMax);
        } else {
    ...
    private void prepareTerrainPreference() {
        ...
        if (premiumMember) {
            terrainMin = preferences.getString(PrefConstants.FILTER_TERRAIN_MIN, terrainMin);
            terrainMax = preferences.getString(PrefConstants.FILTER_TERRAIN_MAX, terrainMax);
        } else {
