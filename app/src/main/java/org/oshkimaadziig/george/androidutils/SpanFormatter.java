...
public class SpanFormatter {
        ...
        while (i < out.length()) {
            ...
            switch (typeTerm) {
                ...
                default:
                    ...
                    } else if ("S".equals(typeTerm) && argItem instanceof Spanned) {
                        cookedArg = spannedToUpperCase((Spanned) argItem);
                    } else {
    ...
    private static Spanned spannedToUpperCase(@NonNull Spanned s) {
