...
public abstract class UserTask<Params, Progress, Result> {
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    android.util.Log.w(LOG_TAG, e);
                	  ...
                	  message = sHandler.obtainMessage(MESSAGE_POST_EXCEPTION, 
                	  		    new UserTaskResult<Result>(UserTask.this, e.getCause(), (Result[]) null));
                    message.sendToTarget();
                    return;
                } catch (CancellationException e) {
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new UserTaskResult<Result>(UserTask.this, null, (Result[]) null));
                    message.sendToTarget();
                    return;
                } catch (Throwable t) {
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new UserTaskResult<Result>(UserTask.this, null, result));
                message.sendToTarget();
            }
        };
    }
     ...
     * 
     * @throws If error occurs in this method exceptions can be handled in {@link #onException(Exception)}. 
     *
     * @see #onPreExecute()
    ...
    /**
     * Runs on the UI thread after {@link #onPostExecute(Object)} or {@link #onCancelled()};
     *
     * @see #onPostExecute(Object)
     * @see #onCancelled()
     */
    ...
    /**
     * Runs on the UI thread when errors occurs in {@link #doInBackground(Object...)} method.
     *
     * @param e Exception
     *
     * @see #doInBackground(Object...)
    ...
    protected final void publishProgress(Progress... values) {
        sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
                new UserTaskResult<Progress>(this, null, values)).sendToTarget();
    }
    ...
    private static class UserTaskResult<Data> {
        ...
        UserTaskResult(UserTask task, Throwable exception, Data... data) {
            mTask = task;
            mData = data;
